...
from product_spiders.scheduler import schedule_spiders, reschedule_crawls
...
if __name__ == '__main__':
    ...
    schedule_spiders(db_session, spider_names, launch=False)
    reschedule_crawls(db_session)
