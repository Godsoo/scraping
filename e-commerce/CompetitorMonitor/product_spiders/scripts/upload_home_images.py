...
def upload_home_screenshots():
    imagespath = os.path.join(config.DATA_DIR, 'home_images')
    scrpath = config.SFT_DST_HOME_IMAGES
    scrpath_tmp = os.path.join(config.SFT_DST_HOME_IMAGES, 'tmp')
...
if __name__ == '__main__':
    pid_file_name = 'home_images_uploader.pid'
