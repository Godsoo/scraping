...
- Create Bike24 Base Spider, three spiders at the moment crawling this website:
  ...
  1. This (crc-de-bike24.com)
  2. zyro-bike24.com (Zyro account)
  3. camelbak-de-bike24.com (Camelbak DE account)
...
from scrapy.spiders import SitemapSpider as Spider
...
class Bike24Spider(Spider):
    ...
    sitemap_urls = ['https://www.bike24.com/sitemap_index_com.xml']
    sitemap_rules = [
        ('/p\d+\.html', 'parse_product'),
    ]
