...
class CrcFRSpider(BaseSpider):
    name = 'crc-fr-chainreactioncycles.com-feed'
    ...
    def parse(self, response):
        ...
        last = get_last_file("CRC_PRICEFEED_France", files)
        ...
        zip_path = HERE+'/CRC_PRICEFEED_France.zip'
        xml_path = HERE+'/CRC_PRICEFEED_France.xml'
        ...
        for item in tree.find('priceList[@id="FranceRP"]').find('prices').findall('price'):
