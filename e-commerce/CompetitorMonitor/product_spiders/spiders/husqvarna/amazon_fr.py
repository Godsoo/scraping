...
class HusqvarnaAmazonScraper(AmazonScraper):
    def scrape_product_details_page(self, response, only_color=False, collect_new_products=True,
        ...
        res = super(HusqvarnaAmazonScraper, self).scrape_product_details_page(response, only_color, collect_new_products,
                                                                              collect_used_products)
