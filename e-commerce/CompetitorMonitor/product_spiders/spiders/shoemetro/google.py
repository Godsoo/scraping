...
KEYS = ['AIzaSyDO5Aexx0MSy-HK9DR0qPtPeAcAoYsySVw',
        'AIzaSyC3nAW89B5XploEG7VNrh1ULHRzDej48jc',
        'AIzaSyCUXjfTHuYpcdWqSgjEdbbqc0aoGwB9BU4',
        'AIzaSyCrtXscq-63qUo2_EzeWwHSc3WqwV9vOfw',
        'AIzaSyALAmLv-TqK9oVDW3PeYBDImq99kDz4tLU',
        'AIzaSyBRZ-tQuwQF84PLq8DN4U9n8qLIus5f_64',
...
class GoogleSpider(BaseSpider):
    ...
    def start_requests(self):
        ...
        with open(os.path.join(HERE,
                'shoemetroall.csv.' + self.name + '.cur')) as f:
            ...
            for i, row in enumerate(reader):
                ...
                url = 'https://www.googleapis.com/shopping/search/v1/public/products?key=%s&country=US&q=%s&restrictBy=condition=new'

                yield Request(
                        url=url % (KEYS[i % len(KEYS)], query),
                        meta={
                                'sku': sku,
