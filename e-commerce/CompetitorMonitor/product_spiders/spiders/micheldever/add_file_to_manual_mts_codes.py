...
from points_spider import PointSSpider
from atseuromaster import ATSEuromasterSpider
from aa import TheAASpider
...
websites_mapping = {
    ...
    'Atseuromaster': ATSEuromasterSpider.name,
