...
class HarveyNormanSpider(SitemapSpider):
    name = 'biw-aus-harveynorman.com.au'
    ...
    # start_urls = [
    #     'http://www.harveynorman.com.au/allure-locking-gen-4-silver-beton-vinyl-flooring.html',
    #     'http://www.harveynorman.com.au/computers-tablets/computers/apple-mac-computers/apple-macbook-air-11-1-4ghz-i5-256gb.html'
    # ]
    ...
    def parse_product(self, response):
        ...
        if not options:
            ...
            if price:
                ...
                elif hxs.select("//div[contains(concat('',@class,''), 'price-device')][contains(., 'Contact us')]"):
                    loader.add_value('price', '0.0')
                else:
