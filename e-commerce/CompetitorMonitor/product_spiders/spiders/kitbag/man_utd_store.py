...
Ticket link: https://www.assembla.com/spaces/competitormonitor/tickets/4924
"""
import re
import json
...
class ManUtdStore(CrawlSpider):
    name = 'kitbag-manutdstore'
    allowed_domains = ['store.manutd.com']
    start_urls = ['http://store.manutd.com/stores/manutd/en/c/football-kits?cur=GBP',
                  'http://store.manutd.com/stores/manutd/en/c/fashion?cur=GBP',
                  'http://store.manutd.com/stores/manutd/en/c/equipment?cur=GBP']
    ...
    def start_requests(self):
        yield Request('http://store.manutd.com/stores/manutd/en/product/manchester-united-sash-football---red-white-black---size-5/184083?cur=GBP',
    ...
    def parse_shipping1(self, response):
        req = Request("http://store.manutd.com/stores/manutd/en/basket/basket?cur=GBP", dont_filter=True,
