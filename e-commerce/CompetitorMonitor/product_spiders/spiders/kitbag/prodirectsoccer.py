...
Ticket: https://app.assembla.com/spaces/competitormonitor/tickets/4930
"""
...
class ProDirectSoccerSpider(Spider):
    name = u'kitbag-prodirectsoccer.com'
    allowed_domains = ['prodirectsoccer.com']
    start_urls = ('http://www.prodirectsoccer.com/replica.aspx',
                  'http://www.prodirectsoccer.com/footballs.aspx',
                  'http://www.prodirectsoccer.com/football-boots.aspx'
                  )
