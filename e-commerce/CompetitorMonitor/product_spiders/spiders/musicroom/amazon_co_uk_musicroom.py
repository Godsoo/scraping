...
class MusicroomAmazonSpider(BaseAmazonSpider):
    name = 'musicroom-amazon.co.uk-musicroom'
    ...
    def _collect_buybox(self, product, meta):
        product['dealer'] = u'AM - Musicroom'
        super(MusicroomAmazonSpider, self)._collect_buybox(product, meta)
    ...
    def get_next_search_request(self, callback=None):
        ...
        url = add_or_replace_parameter(url, 'emi', 'A22XW704D3QODR')  # Only Musicroom products
