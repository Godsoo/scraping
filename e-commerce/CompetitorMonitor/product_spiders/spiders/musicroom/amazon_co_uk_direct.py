...
class MusicroomAmazonDirectSpider(BaseAmazonSpider):
    name = 'musicroom-amazon.co.uk-direct'
    ...
    def __init__(self, *args, **kwargs):
        super(MusicroomAmazonDirectSpider, self).__init__(*args, **kwargs)
    ...
    def _collect_amazon_direct(self, product, meta):
        ...
        elif self.current_search_item and meta.get('search_string'):
