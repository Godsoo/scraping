...
class RetroFurnishFrSpider(BaseSpider):

    name            = 'retrofurnish_fr'
    allowed_domains = ['retrofurnish.com/fr', 'retrofurnish.com']
    ...
    def parse(self, response):
        ...
        yield Request(
            url="http://www.retrofurnish.com/fr",
    ...
    def parse_real(self, response):
        ...
        for category in categories:
            url = category.select('./@href')[0].extract().replace('/en/', '/fr/')
    ...
    def parse_product(self, response):
        ...
        # url = 'http://www.retrofurnish.com/fr/' + response.url.split('/')[-1]
