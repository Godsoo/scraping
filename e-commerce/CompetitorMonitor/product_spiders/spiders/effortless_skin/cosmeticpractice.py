...
class CosmeticPracticeSpider(PrimarySpider):
    name = "www.thecosmeticpractice.co.uk"
    ...
    csv_file = 'thecosmeticpractice_crawl.csv'

    def _start_requests(self):
        yield Request('http://www.thecosmeticpractice.co.uk/anti-ageing-skincare-solutions-c2/fillerina-fillerina-filler-treatment-dermo-cosmetic-filler-treatment-p1149', callback=self.parse_product)
