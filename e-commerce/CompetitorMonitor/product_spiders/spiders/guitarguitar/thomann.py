...
Website: http://www.thomann.de
Copied from studioxchange
"""
...
class ThomannSpider(BaseSpider):
    name = u'guitarguitar-thomann.de'
    ...
    def parse_product(self, response):
        ...
        euro_price = response.xpath('//*[@itemprop="price"]/text()').extract_first()
