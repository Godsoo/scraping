...
def find_mts_stock_code(product, spider_name=None, log=None):
    """
    ...
    >>> product = {'brand': u'Pirelli',\
	 ...
	 'metadata': {u'alternative_speed_rating': 'Y',\
	              u'aspect_ratio': u'35',\
	              u'fitting_method': u'Delivered',\
