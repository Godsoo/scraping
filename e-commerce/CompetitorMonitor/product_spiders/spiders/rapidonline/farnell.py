...
class FarnellSpider(Spider):
    ...
    product_urls = ('http://uk.farnell.com/finder/093-60/separator-plastic/dp/1903527',
                    'http://uk.farnell.com/finder/093-63/module-output-fuse/dp/1903528')
    ...
    def start_requests(self):
        with open(os.path.join(HERE, 'farnell_trial_urls.csv')) as f:
