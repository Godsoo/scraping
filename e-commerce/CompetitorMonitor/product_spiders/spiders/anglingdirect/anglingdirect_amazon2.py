...
class AnglingDirectAmazonSpider2(BaseAmazonSpider):
    name = 'anglingdirect-amazon.com2'
    ...
    def construct_product(self, item, meta=None, use_seller_id_in_identifier=None):
        item = super(AnglingDirectAmazonSpider2, self).construct_product(item, meta, use_seller_id_in_identifier)
