...
class InteriorAddictDESpider(BaseSpider):
    name = 'voga_de-interioraddict.com'
    allowed_domains = ['interioraddict.com']
    start_urls = ('http://www4.interioraddict.com/de/',)

    def __init__(self, *args, **kwargs):
        super(InteriorAddictDESpider, self).__init__(*args, **kwargs)
        self.errors = []
