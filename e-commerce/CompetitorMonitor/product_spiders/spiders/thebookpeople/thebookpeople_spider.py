...
from bookpeopleitem import BookpeopleMeta
...
class TheBookPeopleSpider(BaseSpider):
    name = 'thebookpeople-thebookpeople.co.uk'

    filename = os.path.join(HERE, 'thebookpeople_products.csv')
    ...
    def parse(self, response):
        ...
        file_path = HERE + '/cm_core_txt'

        sftp.get('cm_core.txt', file_path)
