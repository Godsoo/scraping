...
class FarnellSpider(PrimarySpider):
    name = 'arco-a-farnell.com'
    allowed_domains = ['farnell.com']
    start_urls = ('http://cpc.farnell.com/',)

    csv_file = 'farnell_crawl.csv'
    ...
    def start_requests(self):
        ...
        with open(os.path.join(HERE, 'farnell_categories.csv')) as f:
    ...
    def parse(self, response):
        ...
        for product in products:
            try:
                ...
                continue
            if identifier in self.cache_data and price:
