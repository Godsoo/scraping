...
class StyleBopSpider(BaseSpider):
    name = 'stylebop-stylebop.com'
    allowed_domains = ['stylebop.com']
    start_urls = ('http://www.stylebop.com/changeCountry.php?page=setDir&countryId=56&x=23&y=10',)

    def parse(self, response):
        yield Request('http://www.stylebop.com/export/tracking_pilot/us.csv', callback=self.parse_feed)
