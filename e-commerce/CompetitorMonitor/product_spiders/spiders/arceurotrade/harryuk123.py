...
class Harryuk123Spider(BaseSpider):
    name = 'harryuk123'
    allowed_domains = ['ebay.co.uk']

    def __init__(self, *args, **kwargs):
        super(Harryuk123Spider, self).__init__(*args, **kwargs)
 
    def start_requests(self):
        yield Request('http://stores.ebay.co.uk/harryuk123/_i.html?rt=nc&_dmd=1&_sid=88850685&_trksid=p4634.c0.m14&_vc=1', callback=self.parse_product_list)
