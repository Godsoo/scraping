...
class DomuSpider(Spider):
    name = 'andrewjames-domu.co.uk-vonhaus'
    allowed_domains = ['domu.co.uk']
    start_urls = ('http://www.domu.co.uk/catalogsearch/result/index?limit=all-Vonhaus&q=Vonhaus',)
    ...
    def parse_product(response):
        ...
        loader.add_value('brand', 'Vonhaus')
