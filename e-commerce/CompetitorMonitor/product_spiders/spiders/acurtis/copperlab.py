...
class CopperlabSpider(BaseSpider):
    ...
    start_items = (
        ...
        'http://www.copperlab.com/copper-penetration-flashing.html',
        'http://www.copperlab.com/copper-vent-pipe-flashing.html',
        'http://www.copperlab.com/copper-roof-jack-vent.html',
        'http://www.copperlab.com/copper-vent-stack.html',
        'http://www.copperlab.com/tpo-penetration-flashing.html'
        )
