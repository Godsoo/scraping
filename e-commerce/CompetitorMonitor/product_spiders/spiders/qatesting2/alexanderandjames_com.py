...
class AlexanderandjamesComSpider(BaseSpider):
    name = 'qatesting2-alexanderandjames.com_ok'
    allowed_domains = ['alexanderandjames.com']
    start_urls = ('http://www.alexanderandjames.com',)
    jar_counter = 0
    ids = []
    brands = []
    ...
    def __init__(self, *args, **kwargs):
        super(AlexanderandjamesComSpider, self).__init__(*args, **kwargs)
    ...
    def parse_product(self, response):
        ...
        url = '/on/demandware.store/Sites-DiageoUK-Site/default/Cart-MiniAddProduct'
    ...
    def parse_shipping_price1(self, response):
        base_url = get_base_url(response)
        url = '/on/demandware.store/Sites-DiageoUK-Site/default/Cart-Show'
        url = urljoin_rfc(base_url, url)
        yield Request(url,
                      dont_filter=True,
