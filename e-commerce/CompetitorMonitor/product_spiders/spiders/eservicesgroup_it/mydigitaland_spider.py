...
class MyDigitaLandSpider(BaseSpider):
    name = "eservice-it-mydigitaland.com"
    allowed_domains = ["it.mydigitaland.com"]
    start_urls = ["http://it.mydigitaland.com/"]
    ...
    def parse_product(self, response):
        ...
        in_stock = hxs.select('//p[contains(@class, "availability")]/span[text()="Disponibile"]')
        if not in_stock:
