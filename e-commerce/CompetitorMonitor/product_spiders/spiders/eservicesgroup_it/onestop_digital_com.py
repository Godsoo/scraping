...
class OnestopDigitalITSpider(BaseSpider):
    name = u'it-onestop-digital.com'
    allowed_domains = ['onestop-digital.com']
    start_urls = [
        'https://www.onestop-digital.com/index.php?sl=it&currency=EUR'
    ]
