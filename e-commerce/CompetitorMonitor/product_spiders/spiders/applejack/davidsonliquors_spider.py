...
class DavidsonsLiquorsSpider(BaseSpider):
    name = 'applejack-davidsonsliquors.com'
    ...
    def parse_product(self, response):
        ...
        product_size = hxs.select('//div[strong[contains(text(), "Size: ")]]/text()').extract()
        if product_size:
        ...
        image_url = hxs.select('//img[@class="image-retina"]/@retina-image').extract()
