...
class CrcUSpider(BaseSpider):
    name = 'crc-us-chainreactioncycles.com-feed'
    ...
    def parse(self, response):
        ...
        last = get_last_file("CRC_PRICEFEED_USA", files)
        ...
        zip_path = HERE+'/CRC_PRICEFEED_USA.zip'
        xml_path = HERE+'/CRC_PRICEFEED_USA.xml'
        ...
        for item in tree.find('priceList[@id="USARP"]').find('prices').findall('price'):
