...
Website: https://www.lensway.Se
All products in this category http://screencast.com/t/NHlsAaqC

Ticket link: https://app.assembla.com/spaces/competitormonitor/tickets/5090
...
class Lensway(BaseSpider):
    name = "specsavers_sw-lensway.se-new"
    allowed_domains = ["lensway.se"]
    start_urls = ['https://www.lensway.se/kontaktlinser/?sort=name&_page=15']
