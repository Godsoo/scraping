...
"""
Account: CamelBak FR
Name: camelbak_fr-wiggle.fr
Ticket link: https://app.assembla.com/spaces/competitormonitor/tickets/5014
"""
...
class CamelBakWiggle(WiggleSpider):
    name = 'camelbak_fr-wiggle.fr'
    allowed_domains = ['www.wiggle.fr']

    start_urls = ['http://www.wiggle.fr/camelbak/?ps=96']
    ...
    def start_requests(self):
        yield Request('http://www.wiggle.fr',
                      dont_filter=True,
