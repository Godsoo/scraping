...
class CrcSpanishSpider(BaseSpider):
    name = 'chainreactioncycles.com-spanishfeed'
    ...
    def parse(self, response):
        ...
        last = get_last_file("CRC_PRICEFEED_Spain", files)
        ...
        '''
        zip_path = HERE+'/CRC_PRICEFEED_Spain.zip'
        xml_path = HERE+'/CRC_PRICEFEED_Spain.xml'
        ...
        for item in tree.find('priceList[@id="SpainRP"]').find('prices').findall('price'):
