        ...
        with open(os.path.join(HERE, 'EAMatches.csv')) as f:
            ...
            for row in reader:
                if row['Amazon']!="No matches":
                    ...
                    yield Request(row['Amazon'], meta={'search_string': '', 'search_item': s_item}, dont_filter=True, callback=self.parse_product)
