...
class CharterhouseAquaticsSpider(BaseSpider):
    name = 'aquacadabra-charterhouse-aquatics.co.uk'
    ...
    def parse(self, response):
        ...
        categories = hxs.select('//ul[@class="mega-menu"]//a/@href').extract()
    ...
    def parse_products(self, response):
        ...
        for product in products:
            ...
            if product.select('.//h3/a/span[@class="productSpecialPrice"]/text()'):
                loader.add_xpath('price', './/h3/a/span[@class="productSpecialPrice"]/text()')
            else:
