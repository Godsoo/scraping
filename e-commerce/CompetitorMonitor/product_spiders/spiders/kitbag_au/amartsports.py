...
Kitbag AU account
Amartsports spider
Ticket link: https://app.assembla.com/spaces/competitormonitor/tickets/4981
"""
...
class Amartsports(CrawlSpider):
    name = 'kitbag_au-amartsports'
    allowed_domains = ['amartsports.com.au']
    start_urls = ['http://www.amartsports.com.au/store/fangear/soccer-football/604',
                  'http://www.amartsports.com.au/store/sports/football-soccer/322']
