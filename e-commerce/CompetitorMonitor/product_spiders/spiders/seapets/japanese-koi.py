...
class japanesekoi_spider(BaseSpider):
    ...
    def parse_product(self, response):
        ...
        name = hxs.select(u'//div[@class="product-essential"]//div[@class="product-name"]/h1/text()').extract()[0]
        base_price = hxs.select(u'//div[@class="product-essential"]//p[@class="special-price"]/span[@class="price"]/text()').extract()
        if not base_price:
            base_price = hxs.select(u'//div[@class="product-essential"]//span[@class="regular-price"]/span[@class="price"]/text()').extract()
