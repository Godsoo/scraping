...
class Home24Spider(BaseSpider):
    name = 'made_de-home24.de'
    allowed_domains = ['home24.de']
    start_urls = ['http://www.home24.de/moebel/?order=name_desc',
                  'http://www.home24.de/lampen-shop/?order=name_desc',
                  'http://www.home24.de/wohnaccessoires/?order=name_desc']
    ...
    def parse_product(self, response):
        ...
        for url in response.xpath('//meta[@itemprop="isSimilarTo"]/@content').extract():
            ...
            yield Request(url.replace('undefinedundefined', '.de/'), callback=self.parse_product)
