# -*- coding: utf-8 -*-
"""
Customer: Specsavers NZ
Website: http://www.quicklens.co.nz/
...
class QuicklensSpider(BaseSpider):
    name = 'specsavers_nz-quicklens.co.nz'
    allowed_domains = ['quicklens.co.nz']
    start_urls = ['http://www.quicklens.co.nz/index/list/']
