...
"""
Account: SpecSavers NZ
Name: specsavers_nz-clearly.com.nz
...
class ClearlyComAu(Spider):
    name = 'specsavers_nz-clearly.com.nz'
    allowed_domains = ['clearly.co.nz']

    start_urls = ['http://www.clearly.co.nz/catalog/view-all-products-by-name']
