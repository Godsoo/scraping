...
class LSOGoogleShoppingSpiderLampspecs(Spider):
    name = 'lampshoponline-googleshopping.lampspecs'
    allowed_domains = ['google.co.uk']
    start_urls = ['file://' + os.path.join(DATA_DIR, 'lso_google_products.csv')]

    DEALER_NAME = 'Lampspecs'
