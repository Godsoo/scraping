...
class LeaderDoorsSpider(XMLFeedSpider):
    name = 'leaderstores-leaderdoors.co.uk'
    allowed_domains = ['leaderdoors.co.uk']
    start_urls = ('https://www.leaderdoors.co.uk/googleproducts/getXML',)
    itertag = 'item'
