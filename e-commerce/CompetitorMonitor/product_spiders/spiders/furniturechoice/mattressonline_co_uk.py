...
class MattressOnlineCoUkSpider(PrimarySpider):
    name = 'mattressonline.co.uk'
    allowed_domains = ['mattressonline.co.uk']

    csv_file = 'mattressonline.co.uk_products.csv'

    def __init__(self, *args, **kwargs):
        super(MattressOnlineCoUkSpider, self).__init__(*args, **kwargs)
