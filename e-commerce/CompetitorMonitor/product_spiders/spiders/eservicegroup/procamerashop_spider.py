...
class ProCameraShopSpider(BaseSpider):
    name = "eservicegroup-procamerashop.com"
    ...
    def parse_product(self, response):
        ...
        loader.add_xpath('image_url', '//div[@class="viewProductSurround"]/a/img/@src')
        loader.add_xpath('category', '//li[@class="category3"]/a/text()')
        loader.add_xpath('brand', '//span[@class="productsByManufacturer"]/a/text()')
