...
def get_product_info(product_url, r) :
	...
	# 	price     = tr_rate.x('td[1]/div/text()').strip() #need to test more
	...
	s.save( [ 	
				...
				'Max_Interest_Rate', r.x("td[5]"),
				'Max_Monthly_Rate', r.x("td[6]"),
				'Base_Interest_Rate', r.x("td[7]"),
				'Base_Monthly_Rate', r.x("td[8]"),
...
def test():
	get_product_info('http://www.infochoice.com.au/banking/savings-account/citi/citi-online-saver/16663')
